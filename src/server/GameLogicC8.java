...
public class GameLogicC8 {
     ...
     */
    public static void deal(Deck deck, int numCards) {
        for (int i = 0; i < numCards; i++) {
            for (Player player : playerList) {
                player.hand.pickup(deck.pop());
            }
        }
    }

    public static Card pickup(Deck deck){
        return deck.pop();
    }

    public static void playCard(Card card, Deck discard) {
//        checkSpecial(card);
        discard.push(card);
    }
